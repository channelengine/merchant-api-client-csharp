...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class MerchantProductResponse :  IEquatable<MerchantProductResponse>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MerchantProductResponse);
        }

        /// <summary>
        /// Returns true if MerchantProductResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of MerchantProductResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantProductResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
