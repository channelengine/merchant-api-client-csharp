...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class ChannelReturnLineRequest :  IEquatable<ChannelReturnLineRequest>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChannelReturnLineRequest);
        }

        /// <summary>
        /// Returns true if ChannelReturnLineRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ChannelReturnLineRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelReturnLineRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
