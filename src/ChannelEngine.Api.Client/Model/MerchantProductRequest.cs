...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class MerchantProductRequest :  IEquatable<MerchantProductRequest>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MerchantProductRequest);
        }

        /// <summary>
        /// Returns true if MerchantProductRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of MerchantProductRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantProductRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ParentMerchantProductNo == other.ParentMerchantProductNo ||
                    this.ParentMerchantProductNo != null &&
                    this.ParentMerchantProductNo.Equals(other.ParentMerchantProductNo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentMerchantProductNo != null)
                    hash = hash * 59 + this.ParentMerchantProductNo.GetHashCode();
                if (this.Name != null)
