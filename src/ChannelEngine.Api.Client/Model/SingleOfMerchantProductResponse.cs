...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class SingleOfMerchantProductResponse :  IEquatable<SingleOfMerchantProductResponse>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SingleOfMerchantProductResponse);
        }

        /// <summary>
        /// Returns true if SingleOfMerchantProductResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SingleOfMerchantProductResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleOfMerchantProductResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
