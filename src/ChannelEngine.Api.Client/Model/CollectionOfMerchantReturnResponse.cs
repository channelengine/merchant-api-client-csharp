...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class CollectionOfMerchantReturnResponse :  IEquatable<CollectionOfMerchantReturnResponse>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CollectionOfMerchantReturnResponse);
        }

        /// <summary>
        /// Returns true if CollectionOfMerchantReturnResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CollectionOfMerchantReturnResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionOfMerchantReturnResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
