...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class ChannelReturnLineResponse :  IEquatable<ChannelReturnLineResponse>, IValidatableObject
    {
        ...
        public ChannelReturnLineResponse(string ChannelProductNo = default(string), int? Quantity = default(int?))
        {
            // to ensure "ChannelProductNo" is required (not null)
            if (ChannelProductNo == null)
            {
                throw new InvalidDataException("ChannelProductNo is a required property for ChannelReturnLineResponse and cannot be null");
            }
            else
            {
            ...
            if (Quantity == null)
            {
                throw new InvalidDataException("Quantity is a required property for ChannelReturnLineResponse and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ChannelReturnLineResponse);
        }

        /// <summary>
        /// Returns true if ChannelReturnLineResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ChannelReturnLineResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelReturnLineResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
