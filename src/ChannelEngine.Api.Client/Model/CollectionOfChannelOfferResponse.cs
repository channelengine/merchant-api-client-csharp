...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class CollectionOfChannelOfferResponse :  IEquatable<CollectionOfChannelOfferResponse>, IValidatableObject
    {
        ...
        public CollectionOfChannelOfferResponse(List<ChannelOfferResponse> Content = default(List<ChannelOfferResponse>), int? Count = default(int?), int? StatusCode = default(int?), bool? Success = default(bool?), string Message = default(string), Dictionary<string, List<string>> ValidationErrors = default(Dictionary<string, List<string>>))
        {
