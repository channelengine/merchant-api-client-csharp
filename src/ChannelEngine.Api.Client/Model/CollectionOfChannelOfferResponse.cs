...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class CollectionOfChannelOfferResponse :  IEquatable<CollectionOfChannelOfferResponse>, IValidatableObject
    {
        ...
        public CollectionOfChannelOfferResponse(List<ChannelOfferResponse> Content = default(List<ChannelOfferResponse>), int? Count = default(int?), int? TotalCount = default(int?), int? ItemsPerPage = default(int?), int? StatusCode = default(int?), bool? Success = default(bool?), string Message = default(string), Dictionary<string, List<string>> ValidationErrors = default(Dictionary<string, List<string>>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CollectionOfChannelOfferResponse);
        }

        /// <summary>
        /// Returns true if CollectionOfChannelOfferResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CollectionOfChannelOfferResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionOfChannelOfferResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
