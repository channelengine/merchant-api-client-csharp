...
namespace ChannelEngine.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionOfChannelReturnResponse :  IEquatable<CollectionOfChannelReturnResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionOfChannelReturnResponse" /> class.
        /// </summary>
        ...
        public CollectionOfChannelReturnResponse(List<ChannelReturnResponse> Content = default(List<ChannelReturnResponse>), int? Count = default(int?), int? TotalCount = default(int?), int? ItemsPerPage = default(int?), int? StatusCode = default(int?), bool? Success = default(bool?), string Message = default(string), Dictionary<string, List<string>> ValidationErrors = default(Dictionary<string, List<string>>))
        {
        ...
        public List<ChannelReturnResponse> Content { get; set; }
