...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class CollectionOfChannelReturnResponse :  IEquatable<CollectionOfChannelReturnResponse>, IValidatableObject
    {
        ...
        public CollectionOfChannelReturnResponse(List<ChannelReturnResponse> Content = default(List<ChannelReturnResponse>), int? Count = default(int?), int? StatusCode = default(int?), bool? Success = default(bool?), string Message = default(string), Dictionary<string, List<string>> ValidationErrors = default(Dictionary<string, List<string>>))
        {
