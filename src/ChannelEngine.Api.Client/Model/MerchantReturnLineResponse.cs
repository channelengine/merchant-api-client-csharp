...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class MerchantReturnLineResponse :  IEquatable<MerchantReturnLineResponse>, IValidatableObject
    {
        ...
        public MerchantReturnLineResponse(string MerchantProductNo = default(string), int? Quantity = default(int?))
        {
            ...
            if (Quantity == null)
            {
                throw new InvalidDataException("Quantity is a required property for MerchantReturnLineResponse and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MerchantReturnLineResponse);
        }

        /// <summary>
        /// Returns true if MerchantReturnLineResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of MerchantReturnLineResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantReturnLineResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
