...
namespace ChannelEngine.Api.Client.Model
{
    ...
    public partial class MerchantReturnLineRequest :  IEquatable<MerchantReturnLineRequest>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MerchantReturnLineRequest);
        }

        /// <summary>
        /// Returns true if MerchantReturnLineRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of MerchantReturnLineRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantReturnLineRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
