...
namespace ChannelEngine.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionOfMerchantOrderResponse :  IEquatable<CollectionOfMerchantOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CollectionOfMerchantOrderResponse(List<MerchantOrderResponse> Content = default(List<MerchantOrderResponse>), int? Count = default(int?), int? TotalCount = default(int?), int? ItemsPerPage = default(int?), int? StatusCode = default(int?), bool? Success = default(bool?), string Message = default(string), Dictionary<string, List<string>> ValidationErrors = default(Dictionary<string, List<string>>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CollectionOfMerchantOrderResponse);
        }

        /// <summary>
        /// Returns true if CollectionOfMerchantOrderResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CollectionOfMerchantOrderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionOfMerchantOrderResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
