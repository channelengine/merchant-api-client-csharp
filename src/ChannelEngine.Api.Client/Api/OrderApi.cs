...
namespace ChannelEngine.Api.Client.Api
{
    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        /// <returns></returns>
        public OrderApi(ChannelEngine.Api.Client.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Channel: Create Order For channels.    Create a new order in ChannelEngine.
        /// </summary>
        /// <exception cref="ChannelEngine.Api.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="model"></param>
        /// <returns>ApiResponse</returns>
        ...
        /// <summary>
        /// Merchant: Get Orders By Filter For merchants.                Fetch orders based on the provided OrderFilter
        /// </summary>
        /// <exception cref="ChannelEngine.Api.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterStatuses"> (optional)</param>
        /// <param name="filterMerchantOrderNos"> (optional)</param>
        ...
        /// <summary>
        /// Merchant: Get New Orders For merchants.                Fetch newly placed orders (order with status NEW).
        /// </summary>
        /// <exception cref="ChannelEngine.Api.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>CollectionOfMerchantOrderResponse</returns>
        ...
        /// <summary>
        /// Merchant: Download Invoice For merchants.    Generates the ChannelEngine VAT invoice for this order in PDF
        /// </summary>
        /// <exception cref="ChannelEngine.Api.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="merchantOrderNo">The unique order reference as used by the merchant</param>
        /// <param name="useCustomerCulture">Generate the invoice in the billing address&#39; country&#39;s language (optional)</param>
        ...
        /// <summary>
        /// Merchant: Download Packing Slip For merchants.    Generates the ChannelEngine packing slip for this order in PDF
        /// </summary>
        /// <exception cref="ChannelEngine.Api.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="merchantOrderNo">The unique order reference as used by the merchant</param>
        /// <param name="useCustomerCulture">Generate the invoice in the billing address&#39; country&#39;s language (optional)</param>
