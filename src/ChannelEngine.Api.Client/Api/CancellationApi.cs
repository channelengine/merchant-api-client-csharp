...
namespace ChannelEngine.Api.Client.Api
{
    ...
    public partial class CancellationApi : ICancellationApi
    {
        ...
        /// <returns></returns>
        public CancellationApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< CollectionOfChannelCancellationResponse > CancellationIndexWithHttpInfo (DateTime? createdSince)
        {
            ...
            return new ApiResponse<CollectionOfChannelCancellationResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CollectionOfChannelCancellationResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(CollectionOfChannelCancellationResponse)));
        }
