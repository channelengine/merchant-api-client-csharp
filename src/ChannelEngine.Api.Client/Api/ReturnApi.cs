...
namespace ChannelEngine.Api.Client.Api
{
    ...
    public partial class ReturnApi : IReturnApi
    {
        ...
        /// <returns></returns>
        public ReturnApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< CollectionOfMerchantReturnResponse > ReturnGetDeclaredByChannelWithHttpInfo (DateTime? createdSince)
        {
            ...
            return new ApiResponse<CollectionOfMerchantReturnResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CollectionOfMerchantReturnResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(CollectionOfMerchantReturnResponse)));
        ...
        public ApiResponse< CollectionOfChannelReturnResponse > ReturnGetDeclaredByMerchantWithHttpInfo (DateTime? createdSince)
        {
            ...
            return new ApiResponse<CollectionOfChannelReturnResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (CollectionOfChannelReturnResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(CollectionOfChannelReturnResponse)));
