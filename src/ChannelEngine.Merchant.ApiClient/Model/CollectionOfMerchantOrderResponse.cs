...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionOfMerchantOrderResponse")]
    public partial class CollectionOfMerchantOrderResponse : IEquatable<CollectionOfMerchantOrderResponse>, IValidatableObject
    {
        ...
        public CollectionOfMerchantOrderResponse(List<MerchantOrderResponse> content = default(List<MerchantOrderResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
