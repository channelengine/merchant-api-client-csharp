...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MerchantSingleOrderReturnResponse")]
    public partial class MerchantSingleOrderReturnResponse : IEquatable<MerchantSingleOrderReturnResponse>, IValidatableObject
    {
        ...
        public MerchantSingleOrderReturnResponse(string merchantOrderNo = default(string), List<MerchantSingleOrderReturnLineResponse> lines = default(List<MerchantSingleOrderReturnLineResponse>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string merchantReturnNo = default(string), string channelReturnNo = default(string), int? channelId = default(int?), int? globalChannelId = default(int?), string globalChannelName = default(string), ReturnStatus? status = default(ReturnStatus?), int id = default(int), ReturnReason? reason = default(ReturnReason?), string customerComment = default(string), string merchantComment = default(string), decimal refundInclVat = default(decimal), decimal refundExclVat = default(decimal), DateTime? returnDate = default(DateTime?), Dictionary<string, string> extraData = default(Dictionary<string, string>))
        {
