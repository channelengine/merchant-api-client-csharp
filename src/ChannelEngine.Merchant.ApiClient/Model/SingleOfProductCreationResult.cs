...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class SingleOfProductCreationResult : IEquatable<SingleOfProductCreationResult>, IValidatableObject
    {
        ...
        public SingleOfProductCreationResult(ProductCreationResult content = default(ProductCreationResult), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
