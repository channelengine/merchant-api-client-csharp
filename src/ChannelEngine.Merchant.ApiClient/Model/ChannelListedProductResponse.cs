...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class ChannelListedProductResponse : IEquatable<ChannelListedProductResponse>, IValidatableObject
    {
        ...
        public ChannelListedProductResponse(ListedProductChannelStatus? channelStatus = default(ListedProductChannelStatus?), ListedProductExportStatus? exportStatus = default(ListedProductExportStatus?), decimal? lastExportedPrice = default(decimal?), int? lastExportedStock = default(int?))
        {
        ...
        /// <summary>
        /// Returns false as MerchantProductNo should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeMerchantProductNo()
        {
            return false;
        }
