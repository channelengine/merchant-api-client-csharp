...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantOrderLineResponse :  IEquatable<MerchantOrderLineResponse>
    {
        /// <summary>
