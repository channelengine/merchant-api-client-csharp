...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class MerchantOrderLineResponse :  IEquatable<MerchantOrderLineResponse>, IValidatableObject
    {
        ...
        public MerchantOrderLineResponse(OrderStatusView? status = default(OrderStatusView?), bool isFulfillmentByMarketplace = default(bool), string merchantProductNo = default(string), string gtin = default(string), string description = default(string), decimal? unitVat = default(decimal?), decimal? lineTotalInclVat = default(decimal?), decimal? lineVat = default(decimal?), decimal? originalUnitPriceInclVat = default(decimal?), decimal? originalUnitVat = default(decimal?), decimal? originalLineTotalInclVat = default(decimal?), decimal? originalLineVat = default(decimal?), decimal originalFeeFixed = default(decimal), string bundleProductMerchantProductNo = default(string), List<MerchantOrderLineExtraDataResponse> extraData = default(List<MerchantOrderLineExtraDataResponse>), string channelProductNo = default(string), int quantity = default(int), int cancellationRequestedQuantity = default(int), decimal unitPriceInclVat = default(decimal), decimal feeFixed = default(decimal), decimal feeRate = default(decimal), Condition? condition = default(Condition?), DateTime? expectedDeliveryDate = default(DateTime?))
        {
