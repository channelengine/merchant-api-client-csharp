...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MerchantProductExtraDataItemResponse")]
    public partial class MerchantProductExtraDataItemResponse : IEquatable<MerchantProductExtraDataItemResponse>, IValidatableObject
    {
        ...
        protected MerchantProductExtraDataItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantProductExtraDataItemResponse" /> class.
        /// </summary>
        ...
        public MerchantProductExtraDataItemResponse(string key = default(string), string value = default(string), ExtraDataType? type = default(ExtraDataType?), bool isPublic = default(bool))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for MerchantProductExtraDataItemResponse and cannot be null");
            }
            this.Key = key;
            this.Value = value;
            this.Type = type;
