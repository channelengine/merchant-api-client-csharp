...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionOfMerchantOfferGetStockResponse")]
    public partial class CollectionOfMerchantOfferGetStockResponse : IEquatable<CollectionOfMerchantOfferGetStockResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CollectionOfMerchantOfferGetStockResponse(List<MerchantOfferGetStockResponse> content = default(List<MerchantOfferGetStockResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
