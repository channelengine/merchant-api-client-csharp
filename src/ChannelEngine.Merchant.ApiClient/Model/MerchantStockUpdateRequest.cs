...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantStockUpdateRequest :  IEquatable<MerchantStockUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantStockUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MerchantStockUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantStockUpdateRequest" /> class.
        /// </summary>
        ...
        public MerchantStockUpdateRequest(string merchantProductNo = default(string), int? stock = default(int?), int? stockLocationId = default(int?))
        {
            // to ensure "merchantProductNo" is required (not null)
            this.MerchantProductNo = merchantProductNo ?? throw new ArgumentNullException("merchantProductNo is a required property for MerchantStockUpdateRequest and cannot be null");
            this.Stock = stock;
        ...
        {
            return this.Equals(input as MerchantStockUpdateRequest);
        }

        /// <summary>
        /// Returns true if MerchantStockUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantStockUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantStockUpdateRequest input)
        {
            if (input == null)
                return false;
