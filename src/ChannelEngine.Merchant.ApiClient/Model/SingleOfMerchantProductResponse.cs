...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class SingleOfMerchantProductResponse : IEquatable<SingleOfMerchantProductResponse>, IValidatableObject
    {
        ...
        public SingleOfMerchantProductResponse(MerchantProductResponse content = default(MerchantProductResponse), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
