...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MerchantProductRequest")]
    public partial class MerchantProductRequest : IEquatable<MerchantProductRequest>, IValidatableObject
    {
        ...
        protected MerchantProductRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantProductRequest" /> class.
        /// </summary>
        ...
        [DataMember(Name = "ParentMerchantProductNo", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "ParentMerchantProductNo2", EmitDefaultValue = true)]
        ...
        {
            // ParentMerchantProductNo (string) maxLength
            if(this.ParentMerchantProductNo != null && this.ParentMerchantProductNo.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParentMerchantProductNo, length must be less than 64.", new [] { "ParentMerchantProductNo" });
            }

            // ParentMerchantProductNo (string) minLength
            if(this.ParentMerchantProductNo != null && this.ParentMerchantProductNo.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParentMerchantProductNo, length must be greater than 0.", new [] { "ParentMerchantProductNo" });
            }

            // ParentMerchantProductNo2 (string) maxLength
            if(this.ParentMerchantProductNo2 != null && this.ParentMerchantProductNo2.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParentMerchantProductNo2, length must be less than 64.", new [] { "ParentMerchantProductNo2" });
            }

            // ParentMerchantProductNo2 (string) minLength
            if(this.ParentMerchantProductNo2 != null && this.ParentMerchantProductNo2.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParentMerchantProductNo2, length must be greater than 0.", new [] { "ParentMerchantProductNo2" });
            }
