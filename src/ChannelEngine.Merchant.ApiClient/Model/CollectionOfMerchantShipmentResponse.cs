...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class CollectionOfMerchantShipmentResponse : IEquatable<CollectionOfMerchantShipmentResponse>, IValidatableObject
    {
        ...
        public CollectionOfMerchantShipmentResponse(List<MerchantShipmentResponse> content = default(List<MerchantShipmentResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
