...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class SingleOfMerchantSettingsResponse : IEquatable<SingleOfMerchantSettingsResponse>, IValidatableObject
    {
        ...
        public SingleOfMerchantSettingsResponse(MerchantSettingsResponse content = default(MerchantSettingsResponse), int statusCode = default(int), int? logId = default(int?), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
