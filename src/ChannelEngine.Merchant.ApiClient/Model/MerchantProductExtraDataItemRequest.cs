...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantProductExtraDataItemRequest :  IEquatable<MerchantProductExtraDataItemRequest>
    {
        /// <summary>
        ...
        public MerchantProductExtraDataItemRequest(string key = default(string), string value = default(string), TypeEnum? type = default(TypeEnum?), bool? isPublic = default(bool?))
        {
            this.Key = key;
            this.Value = value;
            this.Type = type;
