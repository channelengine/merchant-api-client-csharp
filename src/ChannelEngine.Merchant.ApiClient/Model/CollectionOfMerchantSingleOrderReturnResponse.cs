...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CollectionOfMerchantSingleOrderReturnResponse")]
    public partial class CollectionOfMerchantSingleOrderReturnResponse : IEquatable<CollectionOfMerchantSingleOrderReturnResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CollectionOfMerchantSingleOrderReturnResponse(List<MerchantSingleOrderReturnResponse> content = default(List<MerchantSingleOrderReturnResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
