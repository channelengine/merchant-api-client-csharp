...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class ProductCreationResult : IEquatable<ProductCreationResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as RejectedCount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeRejectedCount()
        {
            return false;
        }
        ...
        /// <summary>
        /// Returns false as AcceptedCount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAcceptedCount()
        {
            return false;
        }
