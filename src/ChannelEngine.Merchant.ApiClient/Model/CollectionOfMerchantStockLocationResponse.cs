...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class CollectionOfMerchantStockLocationResponse : IEquatable<CollectionOfMerchantStockLocationResponse>, IValidatableObject
    {
        ...
        public CollectionOfMerchantStockLocationResponse(List<MerchantStockLocationResponse> content = default(List<MerchantStockLocationResponse>), int count = default(int), int totalCount = default(int), int itemsPerPage = default(int), int statusCode = default(int), string requestId = default(string), string logId = default(string), bool success = default(bool), string message = default(string), Dictionary<string, List<string>> validationErrors = default(Dictionary<string, List<string>>))
        {
