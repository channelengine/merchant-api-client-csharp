...
namespace ChannelEngine.Merchant.ApiClient.Model
{
    ...
    public partial class MerchantShipmentTrackingRequest :  IEquatable<MerchantShipmentTrackingRequest>, IValidatableObject
    {
        ...
        public MerchantShipmentTrackingRequest(string method = default(string), string trackTraceNo = default(string), string returnTrackTraceNo = default(string), string trackTraceUrl = default(string))
        {
