...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface INotificationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfMerchantNotificationResponse>> NotificationIndexAsyncWithHttpInfo (DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), List<NotificationType> types = default(List<NotificationType>), List<string> merchantOrderNos = default(List<string>), List<string> channelOrderNos = default(List<string>), List<string> merchantReturnNos = default(List<string>), List<string> channelReturnNos = default(List<string>), List<string> merchantShipmentNos = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class NotificationApi : INotificationApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantNotificationResponse> localVarResponse = await NotificationIndexAsyncWithHttpInfo(fromDate, toDate, types, merchantOrderNos, channelOrderNos, merchantReturnNos, channelReturnNos, merchantShipmentNos, page, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfMerchantNotificationResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantNotificationResponse>> NotificationIndexAsyncWithHttpInfo (DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), List<NotificationType> types = default(List<NotificationType>), List<string> merchantOrderNos = default(List<string>), List<string> channelOrderNos = default(List<string>), List<string> merchantReturnNos = default(List<string>), List<string> channelReturnNos = default(List<string>), List<string> merchantShipmentNos = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<CollectionOfMerchantNotificationResponse>("/v2/notifications", localVarRequestOptions, this.Configuration, cancellationToken);
