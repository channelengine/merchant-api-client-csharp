...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IReturnApiSync : IApiAccessor
    {
        ...
        CollectionOfMerchantReturnResponse ReturnGetDeclaredByChannel (List<string> merchantOrderNos = default(List<string>), DateTime? createdSince = default(DateTime?), List<ReturnStatus> statuses = default(List<ReturnStatus>), List<ReturnReason> reasons = default(List<ReturnReason>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), int? page = default(int?));
        ...
        ApiResponse<CollectionOfMerchantReturnResponse> ReturnGetDeclaredByChannelWithHttpInfo (List<string> merchantOrderNos = default(List<string>), DateTime? createdSince = default(DateTime?), List<ReturnStatus> statuses = default(List<ReturnStatus>), List<ReturnReason> reasons = default(List<ReturnReason>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), int? page = default(int?));
        /// <summary>
    ...
    public partial class ReturnApi : IReturnApi
    {
        ...
        /// <param name="page">The page to filter on. Starts at 1. (optional)</param>
        /// <returns>CollectionOfMerchantReturnResponse</returns>
        public CollectionOfMerchantReturnResponse ReturnGetDeclaredByChannel (List<string> merchantOrderNos = default(List<string>), DateTime? createdSince = default(DateTime?), List<ReturnStatus> statuses = default(List<ReturnStatus>), List<ReturnReason> reasons = default(List<ReturnReason>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), int? page = default(int?))
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantReturnResponse> localVarResponse = ReturnGetDeclaredByChannelWithHttpInfo(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CollectionOfMerchantReturnResponse</returns>
        public async System.Threading.Tasks.Task<CollectionOfMerchantReturnResponse> ReturnGetDeclaredByChannelAsync (List<string> merchantOrderNos = default(List<string>), DateTime? createdSince = default(DateTime?), List<ReturnStatus> statuses = default(List<ReturnStatus>), List<ReturnReason> reasons = default(List<ReturnReason>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantReturnResponse> localVarResponse = await ReturnGetDeclaredByChannelAsyncWithHttpInfo(merchantOrderNos, createdSince, statuses, reasons, fromDate, toDate, page, cancellationToken);
             return localVarResponse.Data;
