...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IStockLocationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfMerchantStockLocationResponse>> StockLocationIndexAsyncWithHttpInfo (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class StockLocationApi : IStockLocationApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantStockLocationResponse> localVarResponse = await StockLocationIndexAsyncWithHttpInfo(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <exception cref="ChannelEngine.Merchant.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (CollectionOfMerchantStockLocationResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantStockLocationResponse>> StockLocationIndexAsyncWithHttpInfo (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<CollectionOfMerchantStockLocationResponse>("/v2/stocklocations", localVarRequestOptions, this.Configuration, cancellationToken);
