...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IStockLocationApiSync : IApiAccessor
    {
        ...
        /// <param name="merchantStockLocationCreateRequest"> (optional)</param>
        /// <returns>ApiResponse</returns>
        ApiResponse StockLocationCreate(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest));
        ...
        ApiResponse<ApiResponse> StockLocationCreateWithHttpInfo(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest));
        /// <summary>
    ...
    public interface IStockLocationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse> StockLocationCreateAsync(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> StockLocationCreateWithHttpInfoAsync(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the stock locations (or virtual warehouses).
        /// </summary>
        /// <remarks>
    ...
    public partial class StockLocationApi : IStockLocationApi
    {
        ...
        /// <param name="merchantStockLocationCreateRequest"> (optional)</param>
        /// <returns>ApiResponse</returns>
        public ApiResponse StockLocationCreate(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse> localVarResponse = StockLocationCreateWithHttpInfo(merchantStockLocationCreateRequest);
        ...
        /// <param name="merchantStockLocationCreateRequest"> (optional)</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse> StockLocationCreateWithHttpInfo(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest))
        {
            ...
            localVarRequestOptions.Data = merchantStockLocationCreateRequest;
            ...
            var localVarResponse = this.Client.Post<ApiResponse>("/v2/stocklocations", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("StockLocationCreate", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> StockLocationCreateAsync(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse> localVarResponse = await StockLocationCreateWithHttpInfoAsync(merchantStockLocationCreateRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse>> StockLocationCreateWithHttpInfoAsync(MerchantStockLocationCreateRequest merchantStockLocationCreateRequest = default(MerchantStockLocationCreateRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ApiResponse>("/v2/stocklocations", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
