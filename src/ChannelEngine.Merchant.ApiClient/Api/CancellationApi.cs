...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface ICancellationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> CancellationCreateAsyncWithHttpInfo (MerchantCancellationRequest merchantCancellationRequest = default(MerchantCancellationRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class CancellationApi : ICancellationApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse> localVarResponse = await CancellationCreateAsyncWithHttpInfo(merchantCancellationRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse>> CancellationCreateAsyncWithHttpInfo (MerchantCancellationRequest merchantCancellationRequest = default(MerchantCancellationRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ApiResponse>("/v2/cancellations", localVarRequestOptions, this.Configuration, cancellationToken);
