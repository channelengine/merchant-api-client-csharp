...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse> localVarResponse = await OrderGetByFilterAsyncWithHttpInfo(statuses, emailAddresses, merchantOrderNos, channelOrderNos, fromDate, toDate, fromCreatedAtDate, excludeMarketplaceFulfilledOrdersAndLines, fulfillmentType, onlyWithCancellationRequests, page, cancellationToken);
             return localVarResponse.Data;
