...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IOrderApiSync : IApiAccessor
    {
        ...
        /// <param name="toCreatedAtDate">Filter on the created at date in ChannelEngine, until this date. This date is exclusive.&lt;br /&gt;The created date is set on the date and time when the order is created. (optional)</param>
        ...
        /// <param name="channelIds">Filter orders on channel(s). (optional)</param>
        ...
        /// <returns>CollectionOfMerchantOrderResponse</returns>
        CollectionOfMerchantOrderResponse OrderGetNew(int? stockLocationId = default(int?));
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>ApiResponse of CollectionOfMerchantOrderResponse</returns>
        ApiResponse<CollectionOfMerchantOrderResponse> OrderGetNewWithHttpInfo(int? stockLocationId = default(int?));
        /// <summary>
        /// Download Invoice.
        /// </summary>
        /// <remarks>
    ...
    public interface IOrderApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CollectionOfMerchantOrderResponse> OrderGetByFilterAsync(List<OrderStatusView> statuses = default(List<OrderStatusView>), List<string> emailAddresses = default(List<string>), List<string> merchantOrderNos = default(List<string>), List<string> channelOrderNos = default(List<string>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), DateTime? fromCreatedAtDate = default(DateTime?), DateTime? toCreatedAtDate = default(DateTime?), bool? excludeMarketplaceFulfilledOrdersAndLines = default(bool?), FulfillmentType? fulfillmentType = default(FulfillmentType?), bool? onlyWithCancellationRequests = default(bool?), List<int> channelIds = default(List<int>), List<int> stockLocationIds = default(List<int>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CollectionOfMerchantOrderResponse</returns>
        System.Threading.Tasks.Task<CollectionOfMerchantOrderResponse> OrderGetNewAsync(int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfMerchantOrderResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CollectionOfMerchantOrderResponse>> OrderGetNewWithHttpInfoAsync(int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Download Invoice.
        /// </summary>
        /// <remarks>
    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse> OrderGetByFilterWithHttpInfo(List<OrderStatusView> statuses = default(List<OrderStatusView>), List<string> emailAddresses = default(List<string>), List<string> merchantOrderNos = default(List<string>), List<string> channelOrderNos = default(List<string>), DateTime? fromDate = default(DateTime?), DateTime? toDate = default(DateTime?), DateTime? fromCreatedAtDate = default(DateTime?), DateTime? toCreatedAtDate = default(DateTime?), bool? excludeMarketplaceFulfilledOrdersAndLines = default(bool?), FulfillmentType? fulfillmentType = default(FulfillmentType?), bool? onlyWithCancellationRequests = default(bool?), List<int> channelIds = default(List<int>), List<int> stockLocationIds = default(List<int>), int? page = default(int?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(ChannelEngine.Merchant.ApiClient.Client.ClientUtils.ParameterToMultiMap("", "toCreatedAtDate", toCreatedAtDate));
            }
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>CollectionOfMerchantOrderResponse</returns>
        public CollectionOfMerchantOrderResponse OrderGetNew(int? stockLocationId = default(int?))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse> localVarResponse = OrderGetNewWithHttpInfo(stockLocationId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>ApiResponse of CollectionOfMerchantOrderResponse</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse> OrderGetNewWithHttpInfo(int? stockLocationId = default(int?))
        {
            ChannelEngine.Merchant.ApiClient.Client.RequestOptions localVarRequestOptions = new ChannelEngine.Merchant.ApiClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CollectionOfMerchantOrderResponse</returns>
        public async System.Threading.Tasks.Task<CollectionOfMerchantOrderResponse> OrderGetNewAsync(int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse> localVarResponse = await OrderGetNewWithHttpInfoAsync(stockLocationId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfMerchantOrderResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOrderResponse>> OrderGetNewWithHttpInfoAsync(int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <summary>
        /// Update Comment. Update the merchant comment for an order. Either the ChannelEngine order id or the&lt;br /&gt;merchant order number can be used for updating a comment.
        /// </summary>
        /// <exception cref="ChannelEngine.Merchant.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="merchantOrderCommentUpdateRequest"> (optional)</param>
        /// <returns>ApiResponse</returns>
