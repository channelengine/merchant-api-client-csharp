...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IChannelsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfChannelGlobalChannelResponse>> ChannelPluginsGetAsyncWithHttpInfo (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ChannelsApi : IChannelsApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfChannelGlobalChannelResponse> localVarResponse = await ChannelPluginsGetAsyncWithHttpInfo(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <exception cref="ChannelEngine.Merchant.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (CollectionOfChannelGlobalChannelResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfChannelGlobalChannelResponse>> ChannelPluginsGetAsyncWithHttpInfo (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<CollectionOfChannelGlobalChannelResponse>("/v2/channels", localVarRequestOptions, this.Configuration, cancellationToken);
