...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IProductBundleApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfMerchantProductBundleResponse>> ProductBundleGetByFilterAsyncWithHttpInfo (string search = default(string), List<string> eanList = default(List<string>), List<string> merchantProductNoList = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ProductBundleApi : IProductBundleApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantProductBundleResponse> localVarResponse = await ProductBundleGetByFilterAsyncWithHttpInfo(search, eanList, merchantProductNoList, page, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfMerchantProductBundleResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantProductBundleResponse>> ProductBundleGetByFilterAsyncWithHttpInfo (string search = default(string), List<string> eanList = default(List<string>), List<string> merchantProductNoList = default(List<string>), int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<CollectionOfMerchantProductBundleResponse>("/v2/productbundles", localVarRequestOptions, this.Configuration, cancellationToken);
