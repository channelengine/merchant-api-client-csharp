...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IProductApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="ChannelEngine.Merchant.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operation">1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)</param>
        /// <returns>SingleOfProductCreationResult</returns>
        SingleOfProductCreationResult ProductBulkPatch(List<Operation> operation = default(List<Operation>));
        ...
        ApiResponse<SingleOfProductCreationResult> ProductBulkPatchWithHttpInfo(List<Operation> operation = default(List<Operation>));
        /// <summary>
        /// Upsert Products.
        /// </summary>
        /// <remarks>
    ...
    public interface IProductApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SingleOfProductCreationResult> ProductBulkPatchAsync(List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SingleOfProductCreationResult>> ProductBulkPatchWithHttpInfoAsync(List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Upsert Products.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductApi : IProductApi
    {
        ...
        /// <param name="operation">1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)</param>
        /// <returns>SingleOfProductCreationResult</returns>
        public SingleOfProductCreationResult ProductBulkPatch(List<Operation> operation = default(List<Operation>))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult> localVarResponse = ProductBulkPatchWithHttpInfo(operation);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operation">1) PropertiesToUpdate: Fields to update&lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)</param>
        /// <returns>ApiResponse of SingleOfProductCreationResult</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult> ProductBulkPatchWithHttpInfo(List<Operation> operation = default(List<Operation>))
        {
            ChannelEngine.Merchant.ApiClient.Client.RequestOptions localVarRequestOptions = new ChannelEngine.Merchant.ApiClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SingleOfProductCreationResult</returns>
        public async System.Threading.Tasks.Task<SingleOfProductCreationResult> ProductBulkPatchAsync(List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult> localVarResponse = await ProductBulkPatchWithHttpInfoAsync(operation, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfProductCreationResult)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult>> ProductBulkPatchWithHttpInfoAsync(List<Operation> operation = default(List<Operation>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
