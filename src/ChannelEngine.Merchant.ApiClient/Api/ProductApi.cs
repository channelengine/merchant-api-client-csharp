...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IProductApiSync : IApiAccessor
    {
        ...
        /// <returns>SingleOfProductCreationResult</returns>
        SingleOfProductCreationResult ProductCreate(List<MerchantProductRequest> merchantProductRequest);
        ...
        /// <param name="merchantProductRequest"></param>
        /// <returns>ApiResponse of SingleOfProductCreationResult</returns>
        ApiResponse<SingleOfProductCreationResult> ProductCreateWithHttpInfo(List<MerchantProductRequest> merchantProductRequest);
        /// <summary>
        /// Delete Product.
        /// </summary>
        /// <remarks>
    ...
    public interface IProductApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SingleOfProductCreationResult</returns>
        System.Threading.Tasks.Task<SingleOfProductCreationResult> ProductCreateAsync(List<MerchantProductRequest> merchantProductRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfProductCreationResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<SingleOfProductCreationResult>> ProductCreateWithHttpInfoAsync(List<MerchantProductRequest> merchantProductRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete Product.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductApi : IProductApi
    {
        ...
        /// <param name="merchantProductRequest"></param>
        /// <returns>SingleOfProductCreationResult</returns>
        public SingleOfProductCreationResult ProductCreate(List<MerchantProductRequest> merchantProductRequest)
        {
        ...
        /// <param name="merchantProductRequest"></param>
        /// <returns>ApiResponse of SingleOfProductCreationResult</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult> ProductCreateWithHttpInfo(List<MerchantProductRequest> merchantProductRequest)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SingleOfProductCreationResult</returns>
        public async System.Threading.Tasks.Task<SingleOfProductCreationResult> ProductCreateAsync(List<MerchantProductRequest> merchantProductRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfProductCreationResult)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult>> ProductCreateWithHttpInfoAsync(List<MerchantProductRequest> merchantProductRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'merchantProductRequest' is set
            if (merchantProductRequest == null)
                throw new ChannelEngine.Merchant.ApiClient.Client.ApiException(400, "Missing required parameter 'merchantProductRequest' when calling ProductApi->ProductCreate");
