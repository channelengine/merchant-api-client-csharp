...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IProductApiSync : IApiAccessor
    {
        ...
        ApiResponse ProductBulkDelete(List<string> requestBody = default(List<string>));
        ...
        ApiResponse<ApiResponse> ProductBulkDeleteWithHttpInfo(List<string> requestBody = default(List<string>));
        /// <summary>
        /// Bulk Patch Products
        /// </summary>
        /// <remarks>
    ...
    public interface IProductApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse> ProductBulkDeleteAsync(List<string> requestBody = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> ProductBulkDeleteWithHttpInfoAsync(List<string> requestBody = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Bulk Patch Products
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfProductCreationResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<SingleOfProductCreationResult>> ProductCreateWithHttpInfoAsync(List<MerchantProductRequest> merchantProductRequest = default(List<MerchantProductRequest>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete Product.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductApi : IProductApi
    {
        ...
        /// <summary>
        /// Delete multiple Products. Delete the products based on the merchant references.&lt;br /&gt;Note that we do not really delete a products, as the products&lt;br /&gt;might still be referenced by orders etc. Therefore, the references&lt;br /&gt;used for these products cannot be reused. We do however deactivate the products&lt;br /&gt;which means that they will not be sent to channels.
        /// </summary>
        /// <exception cref="ChannelEngine.Merchant.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestBody"> (optional)</param>
        /// <returns>ApiResponse</returns>
        public ApiResponse ProductBulkDelete(List<string> requestBody = default(List<string>))
        {
        ...
        /// <param name="requestBody"> (optional)</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse> ProductBulkDeleteWithHttpInfo(List<string> requestBody = default(List<string>))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> ProductBulkDeleteAsync(List<string> requestBody = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<ApiResponse>> ProductBulkDeleteWithHttpInfoAsync(List<string> requestBody = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult> localVarResponse = await ProductCreateWithHttpInfoAsync(merchantProductRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfProductCreationResult)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfProductCreationResult>> ProductCreateWithHttpInfoAsync(List<MerchantProductRequest> merchantProductRequest = default(List<MerchantProductRequest>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
