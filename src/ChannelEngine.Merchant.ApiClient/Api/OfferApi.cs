...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IOfferApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<SingleOfDictionaryOfStringAndListOfString>> OfferStockPriceUpdateWithHttpInfoAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest = default(List<MerchantStockPriceUpdateRequest>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OfferApi : IOfferApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfDictionaryOfStringAndListOfString)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfDictionaryOfStringAndListOfString>> OfferStockPriceUpdateWithHttpInfoAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest = default(List<MerchantStockPriceUpdateRequest>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
