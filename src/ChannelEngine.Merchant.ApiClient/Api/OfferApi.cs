...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IOfferApiSync : IApiAccessor
    {
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>SingleOfDictionaryOfStringAndListOfString</returns>
        SingleOfDictionaryOfStringAndListOfString OfferStockPriceUpdate(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?));
        ...
        ApiResponse<SingleOfDictionaryOfStringAndListOfString> OfferStockPriceUpdateWithHttpInfo(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?));
    ...
    public interface IOfferApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfMerchantOfferGetStockResponse>> OfferGetStockWithHttpInfoAsync(List<string> skus, List<int> stockLocationIds, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update stock and/or price.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SingleOfDictionaryOfStringAndListOfString> OfferStockPriceUpdateAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SingleOfDictionaryOfStringAndListOfString>> OfferStockPriceUpdateWithHttpInfoAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OfferApi : IOfferApi
    {
        ...
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfMerchantOfferGetStockResponse> localVarResponse = await OfferGetStockWithHttpInfoAsync(skus, stockLocationIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>SingleOfDictionaryOfStringAndListOfString</returns>
        public SingleOfDictionaryOfStringAndListOfString OfferStockPriceUpdate(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfDictionaryOfStringAndListOfString> localVarResponse = OfferStockPriceUpdateWithHttpInfo(merchantStockPriceUpdateRequest, stockLocationId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="stockLocationId">The ChannelEngine id of the stock location. (optional)</param>
        /// <returns>ApiResponse of SingleOfDictionaryOfStringAndListOfString</returns>
        public ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfDictionaryOfStringAndListOfString> OfferStockPriceUpdateWithHttpInfo(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(ChannelEngine.Merchant.ApiClient.Client.ClientUtils.ParameterToMultiMap("", "stockLocationId", stockLocationId));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SingleOfDictionaryOfStringAndListOfString</returns>
        public async System.Threading.Tasks.Task<SingleOfDictionaryOfStringAndListOfString> OfferStockPriceUpdateAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfDictionaryOfStringAndListOfString> localVarResponse = await OfferStockPriceUpdateWithHttpInfoAsync(merchantStockPriceUpdateRequest, stockLocationId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SingleOfDictionaryOfStringAndListOfString)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<SingleOfDictionaryOfStringAndListOfString>> OfferStockPriceUpdateWithHttpInfoAsync(List<MerchantStockPriceUpdateRequest> merchantStockPriceUpdateRequest, int? stockLocationId = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'merchantStockPriceUpdateRequest' is set
            if (merchantStockPriceUpdateRequest == null)
                throw new ChannelEngine.Merchant.ApiClient.Client.ApiException(400, "Missing required parameter 'merchantStockPriceUpdateRequest' when calling OfferApi->OfferStockPriceUpdate");
