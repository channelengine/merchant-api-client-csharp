...
namespace ChannelEngine.Merchant.ApiClient.Api
{
    ...
    public interface IListedProductsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CollectionOfChannelListedProductResponse>> ListedProductGetByFilterAsyncWithHttpInfo (int channelId, int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ListedProductsApi : IListedProductsApi
    {
        ...
        {
             ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfChannelListedProductResponse> localVarResponse = await ListedProductGetByFilterAsyncWithHttpInfo(channelId, page, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CollectionOfChannelListedProductResponse)</returns>
        public async System.Threading.Tasks.Task<ChannelEngine.Merchant.ApiClient.Client.ApiResponse<CollectionOfChannelListedProductResponse>> ListedProductGetByFilterAsyncWithHttpInfo (int channelId, int? page = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<CollectionOfChannelListedProductResponse>("/v2/channels/{channelId}/products", localVarRequestOptions, this.Configuration, cancellationToken);
