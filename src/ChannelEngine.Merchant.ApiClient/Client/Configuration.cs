...
namespace ChannelEngine.Merchant.ApiClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/2.13.0/csharp";
            BasePath = "https://dev.channelengine.local/api";
        ...
        public Configuration(
            ...
            string basePath = "https://dev.channelengine.local/api") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.13.0\n";
