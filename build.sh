...
${nuget_cmd} install src/ChannelEngine.Merchant.ApiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ChannelEngine.Merchant.ApiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ChannelEngine.Merchant.ApiClient.dll \
-recurse:'src/ChannelEngine.Merchant.ApiClient/*.cs' \
-doc:bin/ChannelEngine.Merchant.ApiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ChannelEngine.Merchant.ApiClient.dll was created successfully"
fi
